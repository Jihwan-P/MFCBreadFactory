...
void CTab3Dlg::OnEnChangeEditTempSet() { UpdateMainFrameData(); }
void CTab3Dlg::OnEnChangeEditHumidSet() { UpdateMainFrameData(); }
void CTab3Dlg::OnCbnSelchangeComboMethod() { UpdateMainFrameData(); }